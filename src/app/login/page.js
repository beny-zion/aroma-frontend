    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'linear-gradient(135deg, #F0F5F2 0%, #E1EBE5 50%, #F9FAFB 100%)' }}>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="mx-auto w-64 rounded-2xl bg-[var(--color-primary-50)] px-6 py-5 shadow-lg">
            <img src="/AromaPlus.svg" alt="ארומה פלוס" className="w-full h-auto object-contain" />
          </div>
          <p className="text-[var(--color-text-muted)] mt-3 text-sm">מערכת ניהול מכשירי ריח</p>
        </div>
